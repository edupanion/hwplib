        ...
        for (Row r : table.getRowList()) {
            ...
            for (Cell c : r.getCellList()) {
                ...
                tabBuilder.append("background-color: ").append(ColorUtil.convertToString(color)).append(";")
                        .append(" padding: ")
                        .append(SizeUtil.marginToPx(c.getListHeader().getTopMargin())).append("px ")
                        .append(SizeUtil.marginToPx(c.getListHeader().getBottomMargin())).append("px ")
                        .append(SizeUtil.marginToPx(c.getListHeader().getRightMargin())).append("px ")
                        .append(SizeUtil.marginToPx(c.getListHeader().getLeftMargin())).append("px;")
